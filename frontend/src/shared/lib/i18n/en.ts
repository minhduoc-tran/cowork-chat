export const en = {
  ...
  socket: {
    ...
    taskAssigned: '{{name}} assigned you the task "{{title}}"',
    taskMention: "{{name}} mentioned you in a comment",
    messageMention: "{{name}} mentioned you in a message",
  },
  notifications: {
    title: "Notifications",
    ...
    taskAssigned: '{{name}} assigned you the task "{{title}}"',
    taskMention: '{{name}} mentioned you in the task "{{title}}"',
    messageMention: "{{name}} mentioned you in {{conversation}}",
    someone: "Someone",
