export const vi = {
  ...
  chat: {
    ...
    pinNotify: "Có, thông báo cho mọi người",
    pinSilent: "Ghim trong im lặng",
    pinDialogTitle: "Ghim tin nhắn?",
    pinDialogDescription: "Bạn có muốn thông báo cho mọi người biết bạn đã ghim tin nhắn này không?",
