...
export function ValueInput({ rowId, field, operator, value }: ValueInputProps) {
      ...
      return (
        <div className="flex flex-1 items-center space-x-2">
          <DatePickerInput
            ...
            onChange={(dateStr) =>
              handleChange([dateStr, String(valArr[1])] as FilterValue)
            }
          ...
          <DatePickerInput
            ...
            onChange={(dateStr) =>
              handleChange([String(valArr[0]), dateStr] as FilterValue)
            }
    ...
    return (
      <div className="flex flex-1 items-center space-x-2">
        <Input
          ...
          onChange={(e) =>
            handleChange([e.target.value, String(valArr[1])] as FilterValue)
          }
        ...
        <Input
          ...
          onChange={(e) =>
            handleChange([String(valArr[0]), e.target.value] as FilterValue)
          }
          className="min-w-[80px] flex-1"
        />
      </div>
  ...
  if (field.type === "combobox" && field.fetchOptions) {
    return (
      <ComboboxValueInput field={field} value={value} onChange={handleChange} />
    )
  }
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          role="combobox"
          aria-expanded={open}
          className="min-w-[120px] flex-1 justify-between font-normal"
        >
          {selectedLabel}
